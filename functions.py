...
#     # average
#     left_avg = np.dot(left_lengths, left_lines) / \
#         np.sum(left_lengths) if len(left_lengths) > 0 else None
#     right_avg = np.dot(right_lengths, right_lines) / \
#         np.sum(right_lengths) if len(right_lengths) > 0 else None
